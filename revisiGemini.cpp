...
#include <iostream>
#include <iomanip>
#include <string> // Tambahan header string
using namespace std;
...
void input(){
    ...
    if(n < 11){
        ...
        // Tambahan peringatan jika input lebih dari 10
        cout << "Maksimal data yang diinput adalah 10!\n";
        system("pause");
    }
}
...
void tampil(){
    ...
    cin.ignore();
    cin.get(); // Pastikan bisa menahan layar walau ada sisa buffer
}
